        ...
        <div className='Sales-container pb-2'>
          ...
          <Table striped bordered hover className='Sales-totales'>
              ...
              <tbody>
                ...
                <tr>
                  <td colSpan='2'><strong>Total</strong> ({movemeFee*100}% {t('sales.9','contribución a MoveMe')})</td>
                ...
                <tr>
                  <td colSpan='2'><i>{t('sales.10','Por pagar')}</i></td>
                ...
                <tr>
                  <td colSpan='2'><i>{t('sales.11','Pagado')}</i></td>
              ...
              <Table bordered hover striped className='Sales-detalle' responsive>
                  ...
                  {sales.length>0?sales.filter(item=>item.type.includes('Reto')).sort(sortSales).map((reto,index) => (
                    <tr key={reto.user.uid+reto.instructor.uid+index}>
                      ...
                      <td>{reto.refund?<i>{t('sales.17','Devolución a cliente')}</i>:reto.settle?<i>{t('sales.11','Pagado')}</i>:<i>{t('sales.10','Por pagar')}</i>}</td>
                    </tr>
                  )):null}
