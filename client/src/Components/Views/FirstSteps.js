    ...
    <Header instructor={newInstructor?false:true} />
      <div className='FirstSteps-container d-flex flex-column align-items-center'>
        ...
        <div className='d-flex flex-column align-items-start justify-content-around col-10 mt-3'>
          ...
          <div className='d-flex flex-row align-items-center justify-content-start mt-2'><h3 className='mr-3'>3</h3><p className='text-justify'>{t('fSteps.2','En ')}<strong>{t('fSteps.7','Reto Mensual')}</strong> <Calendar3Fill />{t('fSteps.8',' ¡ desarrolla y activa tu reto ! Agenda clases por Zoom en las semanas del mes. Estas clases se agendarán automáticamente cada mes.')}</p></div>
