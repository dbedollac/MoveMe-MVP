    ...
    <Header instructor={newInstructor?false:true} />
      <div className='FirstSteps-container d-flex flex-column align-items-center'>
        ...
        <div className='d-flex flex-column align-items-start justify-content-around col-10 mt-3'>
          ...
          <div className='d-flex flex-row align-items-center justify-content-start mt-2'><h3 className='mr-3'>3</h3><p className='text-justify'>En <strong>Reto Mensual</strong> <Calendar3Fill /> ¡ desarrolla y activa tu reto ! Agenda clases por Zoom en las semanas del mes. Estas clases se agendarán automáticamnte cada mes.</p></div>
