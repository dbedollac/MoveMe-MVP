...
function GetZoomMeetingsPerClass(props) {
  ...
  return(
      <div>
        ...
        <div key={meeting.meetingID}>
          <StartZoomMeeting startTime={meeting.startTime} title='Iniciar' meetingID={meeting.meetingID}/>
        </div>
      )):null}
    </div>
  )
...
export default GetZoomMeetingsPerClass
