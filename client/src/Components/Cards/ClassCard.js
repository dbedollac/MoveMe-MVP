      ...
      return(
        <div className='card d-flex flex-column ClassCard-container'>
          ...
          <div className=' ClassCard-titulo d-flex flex-column justify-content-around' >
            <p className='text-center px-1' >{props.price!==null?props.price>-1&&!props.misVideos?props.freeVideo?'$0':'$'+Math.ceil(props.price*(1+iva)+StripeFee(props.price*(1+iva))):null:null} {props.title}</p>
