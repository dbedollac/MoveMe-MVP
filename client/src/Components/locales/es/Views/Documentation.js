...
const Documentation = {
  docu: {
    ...
    19:'Fitness Kit',
    20:'En esta página es donde crearás tu Fitness Kit. Selecciona una semana del mes y un día de la semana, luego haz click en "Agregar clase" y elige una de tus clases para agendar una sesión de Zoom a la hora que decidas. Repite este proceso hasta crear un Fitness Kit.',
    21:'Después de que agendes todas las clases por Zoom, fija el precio de tu Fitness Kit. Los usuarios que adquieran tu Fitness Kit tendrán acceso a todas las clases por Zoom del mes, así como a todos los videos que hayas subido a MoveMe. Finalmente, activa tu Fitness Kit para que tus clientes puedan pagar por él y este se ofrezca en el mercado de MoveMe.',
    22:'Ventas',
